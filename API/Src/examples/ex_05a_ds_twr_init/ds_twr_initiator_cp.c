...
#if defined(TEST_DS_TWR_INITIATOR_CP)
...
static dwt_config_t config = {
    ...
    (4097 + 32 - 32),   /* SFD timeout (preamble length + 1 + SFD length - PAC size). Used in RX only. */
...
#define RESP_RX_TO_FINAL_TX_DLY_UUS 5390
/* Receive response timeout. See NOTE 5 below. */
#define RESP_RX_TIMEOUT_UUS 4483
