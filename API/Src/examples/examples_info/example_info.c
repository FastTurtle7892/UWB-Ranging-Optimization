...
#ifdef CUSTOM_DS_TWR_INITIATOR
    extern int custom_ds_twr_initiator(void);

    example_pointer=custom_ds_twr_initiator;
    test_cnt++;
#endif

#ifdef CUSTOM_DS_TWR_RESPONDER
    extern int custom_ds_twr_responder(void);

    example_pointer=custom_ds_twr_responder;
    test_cnt++;
#endif
